...
<div class="container kz-c yz-c">
    ...
    <div class="miaosha">
        <div style="height:168px;width:251px;background:url(<%=request.getContextPath()%>${combo.imgPath}kezhao_main.jpg) no-repeat;background-size:cover"></div>
        <div class="ms-info">
            ...
            <div class="ms-meta" style="position: relative">
                ...
                <a class="liji_yuyue" href="<%=request.getContextPath()%>/online_order?type=2&comboId=${combo.comboId}">
                    在线预约
                </a>
            </div>
            <footer></footer>
